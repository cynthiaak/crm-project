...
function Candidates(){
 ...
 { name: "Nour Khoury", email: "nourkhoury@gmail.com", role: "Frontend Developer", date: "12-8-2025", editor: "Sandra", status: "Shortlisted" },
  ...
  { name: "Tala Hassan", email: "tala.hassan@gmail.com", role: "UI/UX Designer", date: "20-5-2025", editor: "Cynthia", status: "Reviewed" },
  ...
  { name: "Lina Farah", email: "lina.farah@gmail.com", role: "Project Manager", date: "18-4-2025", editor: "Mohamad", status: "Reviewed" },
         ...
         <button className="logout-btn" onClick={handleLogout}>Logout </button>
              ...
              <div className="main-candidates">
                ...
                <div className="main-sort-dropdown-section">
                  <select className="main-sort-dropdown">
