...
function Candidates() {
  ...
  const candidates = [
    ...
    { name: "John Williams", email: "johnwilliams@gmail.com", role: "Frontend Developer", date: "25-6-2025", editor: "Mohamad", status: "Follow-up Funnel" },
    { name: "Mohamed Ali", email: "mohamed.ali@gmail.com", role: "Backend Developer", date: "15-7-2025", editor: "Lara", status: "Reconnect" },
    { name: "Aya Hassan", email: "aya.hassan@gmail.com", role: "UI/UX Designer", date: "20-5-2025", editor: "Cynthia", status: "Fresh Lead" },
    { name: "Samir Khoury", email: "samir.k@gmail.com", role: "Data Analyst", date: "10-8-2025", editor: "Joe", status: "Reconnect" },
    { name: "Mia Davis", email: "miadavis5@gmail.com", role: "Frontend Developer", date: "1-6-2025", editor: "Sandra", status: "Follow-up Funnel" },
          ...
          {filteredCandidates.map((c, index) => (
            ...
            >
              ...
              <span className="status">
                ...
                <span className={`status-dot ${c.status.toLowerCase().replace(/\s/g, '')
                  }`}></span>
                {c.status}
              </span>
            </div>
